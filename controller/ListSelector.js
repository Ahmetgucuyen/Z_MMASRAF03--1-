sap.ui.define([
	...
	return BaseObject.extend("eve.ui.Z_MMASRAF03.controller.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias eve.ui.Z_MMASRAF01.controller.ListSelector
		 */
		...
		selectAListItem : function (sBindingPath) {
			...
			this.oWhenListLoadingIsDone.then(
				...
				function () {
					console.warn("Could not select the list item with the path" + sBindingPath + " because the list encountered an error or had no items");
				}
			);
		},
